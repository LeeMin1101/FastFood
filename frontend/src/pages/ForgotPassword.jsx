...
const ForgotPassword = () => {
  ...
  const handleSendEmail = async (e) => {
    ...
    try {
      const res = await axios.post("https://fastfood-k8cr.onrender.com/api/auth/forgot-password", { email });
  ...
  const handleVerifyOTP = async (e) => {
    ...
    setIsLoading(true); setMessage(""); setError("");
    try {
      const res = await axios.post("https://fastfood-k8cr.onrender.com/api/auth/verify-otp", { email, otp });
      setMessage(res.data.message);
      setStep(3);
      setError("");
    } catch (err) {
  ...
  const handleResetPassword = async (e) => {
    ...
    setIsLoading(true); setMessage(""); setError("");
    try {
      const res = await axios.post("https://fastfood-k8cr.onrender.com/api/auth/reset-password", { email, otp, newPassword });
      setMessage(res.data.message);
